...
@OnlyIn(Dist.CLIENT)
public class MutantSkeletonBow {
	public OldRendererModel armwear;
	public OldRendererModel middle;
	public OldRendererModel middle1;
	public OldRendererModel middle2;
	public OldRendererModel side1;
	public OldRendererModel side2;
	public OldRendererModel side3;
	public OldRendererModel side4;
	public OldRendererModel rope1;
	public OldRendererModel rope2;

	public MutantSkeletonBow(Model model) {
